...
export default function DepositFields ({ paymentMethod, setPaymentMethod, showBankFields, showCurrencies, showCard, showOther }: WithdrawFieldsProps) {
    return (
                <>
                    <Flex direction={"column"} gap={"24px"} w={"100%"} align={"center"} justify={"center"}>
                        <Select
                            ...
                            styles={{
                                label: { color: "#CFCFCF" , marginBottom: '10px', fontFamily: "Poppins, sans-serif", fontWeight: "400", fontSize: "15px", paddingLeft: "10px" },
                                input: {
                                padding: '22px 16px',
                                borderRadius: '12px',
