...
const RestForgotPassword_URL = `${
  BASE_URL.endsWith("/api") ? BASE_URL : BASE_URL + "/api"
}${RestForgotPassword_ENDPOINT}`;
  ...
  return (
    ...
    >
      <Flex align="center" justify={"space-between"} w={"100%"} mb={"50px"}>
        <Box>
          <img src={iconArrow} alt="icon-arrow" onClick={handleBackClick} />
        </Box>
        ...
        <PasswordInput
          ...
          styles={{
            ...
            input: {
              ...
              borderRadius: "12px",
              border: `1px solid ${
                errors.new_password_confirmation ? "red" : orangeColor
              }`,
              background: "none",
              color: grayColor,
              "&::placeholder": {
        ...
        onClick={async () => {
          ...
          if (!authToken) {
            notifications.show({
              title: "Error",
              message:
                "Authentication token not found. Please re-verify your email.",
              color: "red",
              autoClose: 5000,
            });
            return;
          ...
          try {
            await ResetPasswordMutation({
              ...
              new_password_confirmation: passwordCofirm,
              token: authToken,
            });
            setPassword("");
            setPasswordConfirm("");
